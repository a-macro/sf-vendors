...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var introBlocks = document.querySelectorAll(".intro__changeable_block");
  if (introBlocks.length > 0) {
    var parent = document.querySelector(".intro__changeable_blocks");
    parent.setAttribute("data-num", introBlocks.length);
  }
  var sphereCont = document.querySelectorAll(".spheres__container");
  if (sphereCont.length > 0) {
    sphereCont.forEach(function (slider) {
